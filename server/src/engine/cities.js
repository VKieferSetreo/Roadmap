// Eingebaute Städte-Tabelle — deterministischer Geocoding-Fallback.
// Portiert aus src/lib/mock/cities.ts (Frontend-Mock).
 ...
 * sonst ein stabiler Pseudo-Punkt innerhalb Deutschlands.
 */
export function resolveOrt(name) {
