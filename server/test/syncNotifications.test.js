...
describe("Sync-API", () => {
  it("/status liefert Quellen-Status + connector/vollbestand-Flags", async () => {
    ...
    expect(res.body.connectorAnzahl).toBe(43) // +0303 GST-WSV +0129/0130 (RLP/Sachsen) +0224-0228 (5 Städte) +0131/0132 (TH/BB); OSM (0301)/LMS-BW (0122)/Düsseldorf (0217) entfernt
