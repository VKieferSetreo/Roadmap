...
describe("Sync-API", () => {
  it("/status liefert Quellen-Status + connector/vollbestand-Flags", async () => {
    ...
    expect(res.body.connectorAnzahl).toBe(52) // … +0155 (Rostock VZ) +0156 (ViP.NRW) +0157 (SEVAS NRW Restriktionen); OSM (0301)/LMS-BW (0122)/Düsseldorf (0217)/Bedarfsumleitungen-HH (0113) entfernt
