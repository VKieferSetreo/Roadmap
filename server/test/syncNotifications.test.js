...
describe("Sync-API", () => {
  it("/status liefert Quellen-Status + connector/vollbestand-Flags", async () => {
    ...
    expect(res.body.connectorAnzahl).toBe(46) // +0303 +0129/0130 +0224-0228 +0131/0132 +0229 +0150 (Autobahn lastbeschr. Brücken) +0133 (Berlin Durchfahrtshöhen) +0134 (Hamburg Verkehrszeichen); OSM (0301)/LMS-BW (0122)/Düsseldorf (0217)/Bedarfsumleitungen-HH (0113) entfernt
