...
describe("Sync-API", () => {
  it("/status liefert Quellen-Status + connector/vollbestand-Flags", async () => {
    ...
    expect(res.body.connectorAnzahl).toBe(51) // … +0153 (BASt) +0154 (LSBB ST) +0155 (Rostock VZ) +0156 (ViP.NRW Baustellen/Sperrungen); OSM (0301)/LMS-BW (0122)/Düsseldorf (0217)/Bedarfsumleitungen-HH (0113) entfernt
