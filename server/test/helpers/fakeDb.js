...
export function createFakeDb() {
  const state = {
    ...
    findings: [],
    obstacles: [],
    obstacleAenderungen: [], // GL-Änderungstracking: { id, obstacle_id, kategorie, quellen_id, strassen_ref, gueltig_von, gueltig_bis, erkannt_am, created_at }
    runs: [],
