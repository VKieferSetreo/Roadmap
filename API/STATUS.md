...
| 🟢 | Mecklenburg-Vorpommern | OpenStreetMap via Overpass / Geofabrik-Extrakt | GST-Restriktionen — maxheight, | OSM-JSON → GeoJSON | offen |
...
| 🟢 | Nordrhein-Westfalen / Aachen | Aachen — Baustellen Stadtgebiet Aachen (BSIS) | amtlich erfasste Straßenbauste | WFS 2.0.0 (GeoJSON / G | offen |
...
| 🟢 | Saarland | GeoPortal Saarland (GDI-SL) — Verkehr_WFS + IN | Verkehrs-Geodaten (Strassennet | OGC API Features (OAF) | offen |
...
| 🟢 | Sachsen | GeoSN INSPIRE/ATKIS Basis-DLM — Verkehrsnetze  | Verkehrsnetz-Topologie (INSPIR | WFS 2.0 | offen |
| 🟢 | Sachsen | Großraum- und Schwertransporte — gesperrte Brü | Brücken mit begrenzter Tragfäh | PDF je Landkreis (8 LK | offen |
| 🟢 | Sachsen | OpenStreetMap via Overpass / Geofabrik-Extrakt | GST-Restriktionen — maxheight, | OSM-JSON → GeoJSON | offen |
...
| 🟢 | Thüringen | OpenStreetMap via Overpass / Geofabrik-Extrakt | GST-Restriktionen — maxheight, | OSM-JSON → GeoJSON | offen |
...
| 🟢 | Sonstige | Overpass API (OpenStreetMap Query-Engine) | Restriktionen aus OSM-Tags: ma | Overpass-QL (POST/GET) | offen |
| 🟢 | Sonstige | QLever (OSM als SPARQL / GeoSPARQL) | Ganz OSM analytisch abfragbar  | SPARQL (POST) -> JSON  | offen |
